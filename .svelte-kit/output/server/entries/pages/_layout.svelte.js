...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  $$unsubscribe_theme();
  return `<header class="sticky top-0 z-50 bg-white/80 dark:bg-dark-custom/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 transition-colors duration-300"><div class="max-w-3xl lg:max-w-4xl mx-auto px-6 lg:px-8"><div class="flex items-center justify-between h-12 lg:h-14"> <a href="/" class="py-2 sm:py-2 lg:py-4">${$theme === "dark" ? `<img src="/images/logodana-dark.png" alt="Pradana Logo" class="h-6 sm:h-7 lg:h-8 w-auto">` : `<img src="/images/logodana-light.png" alt="Pradana Logo" class="h-6 sm:h-7 lg:h-8 w-auto">`}</a>  <nav class="hidden md:flex items-center space-x-8 lg:space-x-10 xl:space-x-12"><a href="/" class="${"text-sm lg:text-base text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors " + escape(
