...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-1c01gtg_START -->${$$result.title = `<title>Reach Me! - Pradana Yahya</title>`, ""}<meta name="description" content="Get in touch with Pradana Yahya - Developer and Tech Enthusiast"><!-- HEAD_svelte-1c01gtg_END -->`, ""} <div class="max-w-2xl mx-auto px-6 sm:px-20 py-8 sm:py-16"> <section class="text-center mb-8 sm:mb-16" data-svelte-h="svelte-1owlwb0"><h1 class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-gray-900 dark:text-gray-50 mb-4 sm:mb-8">Reach Me!</h1></section>  <section class="space-y-4 sm:space-y-8"> <div class="flex items-center justify-start"><a href="mailto:pradanayahyaabdillah@mail.ugm.ac.id" class="flex items-center space-x-2 sm:space-x-3 text-sm sm:text-lg text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 transition-colors group"><div class="p-1.5 sm:p-2 bg-red-100 dark:bg-red-900/20 rounded-lg group-hover:bg-red-200 dark:group-hover:bg-red-900/30 transition-colors">${validate_component(Mail, "Mail").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</div> <span class="underline break-all sm:break-normal" data-svelte-h="svelte-1l86l3y">pradanayahyaabdillah@mail.ugm.ac.id</span></a></div>  <div class="flex items-center justify-start"><a href="https://www.linkedin.com/in/pradana-yahya/" target="_blank" rel="noopener noreferrer" class="flex items-center space-x-2 sm:space-x-3 text-sm sm:text-lg text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-500 transition-colors group"><div class="p-1.5 sm:p-2 bg-blue-100 dark:bg-blue-900/20 rounded-lg group-hover:bg-blue-200 dark:group-hover:bg-blue-900/30 transition-colors">${validate_component(Linkedin, "Linkedin").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</div> <span class="underline" data-svelte-h="svelte-1xau291">Pradana Yahya Abdillah</span></a></div>  <div class="flex items-center justify-start"><a href="https://github.com/haipradana" target="_blank" rel="noopener noreferrer" class="flex items-center space-x-2 sm:space-x-3 text-sm sm:text-lg text-gray-700 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-200 transition-colors group"><div class="p-1.5 sm:p-2 bg-gray-100 dark:bg-gray-900/20 rounded-lg group-hover:bg-gray-200 dark:group-hover:bg-gray-900/30 transition-colors">${validate_component(Github, "Github").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</div> <span class="underline" data-svelte-h="svelte-1wyzmcv">pradanaabdillah</span></a></div></section></div>`;
});
export {
  Page as default
};
